 ...
 *
 * $Header: /home/jalembke/cvs/ConsoleTools/reboot/libannex/srpc.c,v 1.1 2002/01/14 19:24:23 brylow Exp $
 *
 * This file created by RCS from:
 *
 * $Source: /home/jalembke/cvs/ConsoleTools/reboot/libannex/srpc.c,v $
 *
 * Revision History:
 *
 * $Log: srpc.c,v $
 * Revision 1.1  2002/01/14 19:24:23  brylow
 * - Source for terminal annex version of be-reset.
 *
 * Revision 8.0  1994/04/06  21:36:44  trinkle
 * Annex version 8.0
 *
 * Revision 1.15  92/11/23  14:19:13  carlson
...
#define RCSDATE $Date: 2002/01/14 19:24:23 $
#define RCSREV	$Revision: 1.1 $
#define RCSID   "$Header: /home/jalembke/cvs/ConsoleTools/reboot/libannex/srpc.c,v 1.1 2002/01/14 19:24:23 brylow Exp $"
#ifndef lint
...
unsigned long		pid,	/*  supposedly unique pep id  */
...
unsigned long		pid;		/* PID to return to remote caller */
...
char	*password;
{
	...
	for(i = 0; i < KEYSZ; i += sizeof(unsigned long))
	{
	    key = random_long();
	    (void)bcopy((char *)&key, &password[i], sizeof(unsigned long));
	}
